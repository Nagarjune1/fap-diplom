...
public class AutomataDeformerTest {
	...
	private AutomataDeformer deformer;
	...
	@Before
	public void init() {
		FuzzyAutomata automata = AutomataCreator.createAutomata1();
		deformer = new AutomataDeformer(automata);
	}
	...
	private void checkWord(double degreeVal, String... symbolsLbls) {
		...
		FuzzyAutomata automata = deformer.getAutomata(PRECISION);

		Degree actualDegree = automata.degreeOfWord(word);
