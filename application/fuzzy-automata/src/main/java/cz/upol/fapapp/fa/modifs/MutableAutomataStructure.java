...
public class MutableAutomataStructure {
	...
	public MutableAutomataStructure(Set<Symbol> alphabet, Set<State> states,
	...
	public MutableAutomataStructure(Alphabet alphabet, Set<State> states,
	...
	public MutableAutomataStructure(BaseFuzzyAutomata automata) {
		this(automata.getAlphabet(), automata.getStates(), automata.getTransitionFunction(),
				automata.getInitialStates(), automata.getFinalStates());
	}
	...
	public FuzzyAutomata toAutomata(Integer precisionOrNull) {
		...
		if (!hasEpsilonRules) {
			...
			return new FuzAutWithEpsilonMoves(alphabet, states, transitionFunction, initialStates, finalStates, precisionOrNull);
		}
	}
