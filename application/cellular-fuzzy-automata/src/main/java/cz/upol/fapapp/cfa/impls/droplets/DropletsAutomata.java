...
/**
 * Based on {@link https://sanojian.github.io/cellauto/}
 * 
 * @author martin
 *
 */
public class DropletsAutomata extends CellularFuzzyAutomata {

	public DropletsAutomata(int size, DropletsGenerator generator) {
		super(size, //
