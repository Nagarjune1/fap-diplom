...
/**
 * Base structure containing the definition of the fuzzy tree automata and
 * specification of algorithms.
 * 
 * @author martin
 *
 */
public abstract class BaseFuzzyTreeAutomaton implements BaseAutomaton {
	...
	public BaseFuzzyTreeAutomaton(Set<State> states, Alphabet nonterminals, Alphabet terminals,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BaseFuzzyTreeAutomaton other = (BaseFuzzyTreeAutomaton) obj;
		if (finalStates == null) {
	...
	public String toString() {
		return "FuzzyTreeAutomaton [states=" + states + ", nonterminals=" + nonterminals + ", terminals=" + terminals
				+ ", transitionFunction=" + transitionFunction + ", finalStates=" + finalStates + "]";
	}

	@Override
	public void print(PrintStream to) {
		Printable.print(to, new FTATIMComposer(), (FuzzyTreeAutomaton) this);
	}
