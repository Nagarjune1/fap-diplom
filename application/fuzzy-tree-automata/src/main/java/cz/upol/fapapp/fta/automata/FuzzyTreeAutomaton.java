...
/**
 * Implementation of fuzzy tree automaton.
 * 
 * @author martin
 *
 */
public class FuzzyTreeAutomaton extends BaseFuzzyTreeAutomaton {

	public FuzzyTreeAutomaton(Set<State> states, Alphabet nonterminals, Alphabet terminals,
