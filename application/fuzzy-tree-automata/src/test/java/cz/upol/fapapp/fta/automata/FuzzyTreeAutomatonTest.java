...
public class FuzzyTreeAutomatonTest {
	...
	public void test() {
		...
		FuzzyTreeAutomaton fta = createFuzzyTreeAutomaton();
	...
	private FuzzyTreeAutomaton createFuzzyTreeAutomaton() {
		// states
		...
		// automaton
		FuzzyTreeAutomaton fta = new FuzzyTreeAutomaton(states, nonterminals, terminals, transitionFunction, finalStates);
		return fta;
	}
