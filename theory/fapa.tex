...
\begin{definition}[Automat rozpoznávající $\omega$ (nedeterministický)]
...
%\subsection{Fuzzy deformovaný automat}
%Další ze způsobů, jak přijímat řetězec podobný vzorovému je s využitím deformovaného automatu. 
