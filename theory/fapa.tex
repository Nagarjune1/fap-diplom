...
\begin{note}
  V souvislosti s problémem městského růstu se často opomíjí rozdíl mezi buněčnými automaty a fuzzy buněčnými automaty, vzhledem k tomu, že i řešení s pomocí \uv{klasických} buněčných automatů většinou pracují s určitou odstupňovaností. Obvykle se však nemluví o stupních pravdivosti, ale o určitých diskrétních hodnotách, u kterých často ani není vyžadováno uspořádání.
\end{note}
