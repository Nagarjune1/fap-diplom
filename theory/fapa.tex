...
Zde \cite{ManPra-PriPatDetUsFiStMaFuzTra}. Co dodat? Automat fuzzy-sleduje vzory v časovém průběhu výše ceny na trhu. Např. \uv{cena prudce vzrostla}. 
...
\subsection{Zbytek, ostatní}

Smetí na závěr: pattern matching \cite{Pee-FuzAcSynPatRec} (myslím, že spíš jazyků), \cite{Lee-AppFuzLanPatRec} pattern matching a obrázky (něco na způsob vektorů -- kostel a tak), \cite{Gog-ConRepNatArtLang} asi pattern matching.
